...
**Acceptance Criteria**:
- [ ] AC-001: Accounts được nhóm thành 4 trạng thái: HEALTHY (>3 ngày), WARNING (1-3 ngày), CRITICAL (<72h), EXPIRED
...
|----|-----------|-------------|-----------|
| BR-001 | Session Status Classification | HEALTHY: >3 ngày, WARNING: 1-3 ngày, CRITICAL: <72h, EXPIRED: đã hết hạn hoặc không có session | None |
