...
Khi tạo preset, xác định output path như sau:

| Điều kiện | Output Path | Cấu trúc |
|-----------|-------------|----------|
| Có `packages/core/rule-presets/` | `packages/core/rule-presets/<preset-slug>/` | Có subfolder |
| Không có | `.jai1/rule-preset/` | Files trực tiếp, KHÔNG có subfolder |

**Ví dụ:**

```
# Khi có packages/core/rule-presets/
packages/core/rule-presets/my-preset/
├── preset.json
├── 01-project.md
├── 02-standards.md
└── ...

# Khi không có (project thông thường)
.jai1/rule-preset/
├── 01-project.md
├── 02-standards.md
├── 03-frontend.md
